...
const PageHeader: React.FC = () => {
  return (
    <div className="relative h-64 md:h-80 bg-primary overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/256431/pexels-photo-256431.jpeg')] bg-cover bg-center">
        <div className="absolute inset-0 bg-primary bg-opacity-75"></div>
      </div>
      
      <div className="relative h-full container-custom flex flex-col justify-center">
        <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">البرامج الدراسية</h1>
